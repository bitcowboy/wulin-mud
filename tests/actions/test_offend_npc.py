...
async def test_player_offends_sun_drops_affection_and_mood(
    ...
    assert sun_after.player_relationship.affection == pytest.approx(-0.15)
    assert sun_after.mood.valence == pytest.approx(valence_before - 0.1)
